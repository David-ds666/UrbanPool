            ...
            <table className="admin-table">
              ...
              <tbody>
                {recentRides.map(ride => (
                  <tr key={`${ride.type}-${ride.id}`}>
                    <td className="col-id">#{ride.id}</td>
                    <td>
                      <span style={{
                        fontSize: '11px', fontWeight: 700, padding: '2px 8px',
                        borderRadius: '20px',
                        background: ride.type === 'Carpool' ? '#f0fdf4' : '#f8fafc',
                        color: ride.type === 'Carpool' ? '#059669' : '#374151',
                        border: `1px solid ${ride.type === 'Carpool' ? '#a7f3d0' : '#e2e8f0'}`,
                      }}>{ride.type}</span>
                    </td>
                    ...
                    <td style={{ fontSize: '12px', color: '#6b7280' }}>
                      ...
                      {ride.vehicle && ride.vehicle !== '—' && (
                        <span style={{ display: 'block', fontSize: '11px', color: '#94a3b8' }}>{ride.vehicle}</span>
                      )}
                    </td>
