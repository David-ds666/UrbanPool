    ...
    <div className="earnings-page">
      ...
      <div className="earnings-summary-grid">
        {SUMMARY_CARDS.map((card, i) => (
          <div key={i} className="earnings-summary-card" style={{ borderTop: "3px solid #111" }}>
            <span className="earnings-card-label">{card.label}</span>
            <span className="earnings-card-value" style={{ color: "#111" }}>₹{card.value}</span>
          </div>
        ))}
      </div>
                ...
                <div className="chart-bar-track">
                  <div
                    ...
                    style={{
                      height: `${height}%`,
                      background: isToday
                        ? "linear-gradient(180deg, #111, #374151)"
      ...
      <div className="earnings-transactions">
        ...
        {transactions.length === 0 ? (
          <div className="earnings-empty">
            <span>💰</span>
            <p>No ride earnings yet. Offer a ride and get passengers to start earning!</p>
          </div>
        ) : (
